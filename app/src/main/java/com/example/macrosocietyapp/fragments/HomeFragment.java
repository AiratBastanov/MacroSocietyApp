...
public class HomeFragment extends Fragment {
    ...
    private Button buttonGoToLogin,buttonGoToRegister;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        buttonGoToLogin = viewHomeFragment.findViewById(R.id.buttonGoToLogin);
        buttonGoToRegister = viewHomeFragment.findViewById(R.id.buttonGoToRegister);

        buttonGoToLogin.setOnClickListener(v -> {
            LoginFragment loginFragment = new LoginFragment();
            ((MainActivity) requireActivity()).replaceFragment(loginFragment);
        });

        buttonGoToRegister.setOnClickListener(v -> {
            RegisterFragment registerFragment = new RegisterFragment();
            ((MainActivity) requireActivity()).replaceFragment(registerFragment);
        });
